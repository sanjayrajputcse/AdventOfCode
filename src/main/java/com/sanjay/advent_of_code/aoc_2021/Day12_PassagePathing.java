...
public class Day12_PassagePathing {
    ...
    public static void main(String[] args) {
        ...
        String[] input2 = {"dc-end", "HN-start", "start-kj", "dc-start", "dc-HN", "LN-dc", "HN-end", "kj-sa", "kj-HN", "kj-dc"};

        String[] myInput = {
                "pg-CH", "pg-yd", "yd-start", "fe-hv", "bi-CH", "CH-yd", "end-bi", "fe-RY", "ng-CH", "fe-CH", "ng-pg",
                "hv-FL", "FL-fe", "hv-pg", "bi-hv", "CH-end", "hv-ng", "yd-ng", "pg-fe", "start-ng", "end-FL", "fe-bi",
                "FL-ks", "pg-start"
        };
